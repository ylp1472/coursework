...
function CategoryEditModal({ isOpen, onClose, item, onSave }) {
					...
					<form onSubmit={handleSubmit} className="w-full flex flex-col items-center justify-center gap-10">
						<div className="w-full flex flex-col items-center justify-center gap-5">
							<span className="w-full flex flex-col items-center justify-center gap-2.5">
								<label htmlFor="name" className="w-full text-xs text-gray-500">Name:</label>
								<input
									id="name"
									type="text"
									name="name"
							...
							<span className="w-full flex flex-col items-center justify-center gap-2.5">
								<label htmlFor="image" className="w-full text-xs text-gray-500">Image URL:</label>
								<input
									id="image"
									type="url"
									name="image"
